...
def buildStump(dataArr, labelArr, D):
    ...
    for i in range(n):
        ...
        for j in range(-1, int(numSteps)+1):
            # 给定切分点，不知道<切分点是反例，还是>是反例！！！！
            for inequal in ['lt', 'gt']:
                # threshVal单增：j如果是-1，那么得到rangeMin-stepSize; 如果是numSteps，那么得到rangeMax
                ...
                if weightedError < minError:
                    ...
                    bestClasEst = predictedVals.copy()   #不是指向
                    bestStump['dim'] = i
